...
int modulo_testing()
{
    ...
    int x = get_int("Enter the divident you want to remainder of");

    int y = get_int("Enter the divisor");
...
int integer_division_testing()
{
    ...
    printf("The result of %d divided by %d is %d", x, y, division);
...
int float_cast_to_integer_division_testing()
{
    ...
    float x = get_float("Enter the divident you want to remainder of");

    float y = get_float("Enter the divisor");

    float result = x / y;
 
    int int_result = (int) result;

    printf("The result of %f divided by %f is %f", x, y, result);
...
string print_ascii_string_value()
{
    ...
    string str = get_string("what string do you want to know the ascii alues of the letters of?");
